...
})({"lI2eY":[function(require,module,exports) {
...
var _familytreeJs = require("@balkangraph/familytree.js");
var _familytreeJsDefault = parcelHelpers.interopDefault(_familytreeJs);
...
function buildFamilyTree(data) {
    ...
    new (0, _familytreeJsDefault.default)(document.getElementById("familytree"), {
        dataSource: nodes,
        nodeBinding: {
            field_0: "name",
            img_0: "img"
        },
        mouseScrool: (0, _familytreeJsDefault.default).action.none,
        nodes: nodes
    });
}

},{"@balkangraph/familytree.js":"1BAew","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1BAew":[function(require,module,exports) {
var FamilyTree = function(e, t) {
    ...
    this._event_id = FamilyTree._guid(), FamilyTree._validateConfig(this.config) && (this._vScroll = {}, this.config.ui || (this.ui = FamilyTree.ui), this.config.editUI ? this.editUI = this.config.editUI : this.editUI = new FamilyTree.editUI, this.editUI.init(this), this.config.filterUI ? this.filterUI = this.config.filterUI : this.filterUI = new FamilyTree.filterUI, this.filterUI.init(this), this.manager = new FamilyTree.manager(this), this.config.searchUI ? this.searchUI = this.config.searchUI : this.searchUI = new FamilyTree.searchUI, this.config.nodeMenuUI ? this.nodeMenuUI = this.config.nodeMenuUI : this.nodeMenuUI = new FamilyTree.menuUI, this.nodeMenuUI.init(this, this.config.nodeMenu), this.config.nodeCircleMenuUI ? this.nodeCircleMenuUI = this.config.nodeCircleMenuUI : this.nodeCircleMenuUI = new FamilyTree.circleMenuUI, this.nodeCircleMenuUI.init(this, this.config.nodeCircleMenu), this.config.nodeContextMenuUI ? this.nodeContextMenuUI = this.config.nodeContextMenuUI : this.nodeContextMenuUI = new FamilyTree.menuUI, this.nodeContextMenuUI.init(this, this.config.nodeContextMenu), this.config.toolbarUI ? this.toolbarUI = this.config.toolbarUI : this.toolbarUI = new FamilyTree.toolbarUI, this.config.notifierUI ? this.notifierUI = this.config.notifierUI : this.notifierUI = new FamilyTree.notifierUI, this.notifierUI.init(this), this.config.menuUI ? this.menuUI = this.config.menuUI : this.menuUI = new FamilyTree.menuUI, this.menuUI.init(this, this.config.menu), this.config.xScrollUI || (this.xScrollUI = new FamilyTree.xScrollUI(this.element, this.config, function() {
        ...
        i.isVisible = e, !1 !== FamilyTree.events.publish("visibility-change", [
            i
        ]) && FamilyTree.LAZY_LOADING && i.isVisible && (i._loaded ? i._draw(!1, FamilyTree.action.update) : (i._setInitialSizeIfNotSet(), i._draw(!1, FamilyTree.action.init)));
    }));
};
FamilyTree._defaultConfig = function(e) {
        ...
        if (FamilyTree.LAZY_LOADING || this._initialized || (this._setInitialSizeIfNotSet(), 0 != this.width() && 0 != this.height())) {
            ...
            this.manager.read(e, this.width(), this.height(), n, t, i, function(e) {
                if (!a.notifierUI.show(e.notif)) {
                    ...
                    FamilyTree.events.publish("renderdefs", [
                        a,
                        n
                    ]);
                    ...
                    FamilyTree.events.publish("prerender", [
                        a,
                        n
                    ]), o = n.content;
                    var c = [];
                    if (FamilyTree.RENDER_LINKS_BEFORE_NODES) for(var m = 0; m < e.visibleNodeIds.length; m++){
                    ...
                    if (FamilyTree.events.publish("render", [
                        a,
                        n
                    ]), o = n.content, e = n.res, o += a.ui.lonely(a.config), t !== FamilyTree.action.exporting) {
                        ...
                        var y = !1, g = a.response.animations;
                        if (g[0].length > 0) {
                            ...
                            FamilyTree.animate(g[0], g[1], g[2], a.config.anim.duration, a.config.anim.func, function() {
                                y || (r && r(), FamilyTree.events.publish("redraw", [
                                    a
                                ]), a._showAfterAnimation(), y = !0);
                            });
                        }
                        t === FamilyTree.action.centerNode ? FamilyTree.animate(a.getSvg(), {
                            ...
                            a.ripple(i.options.rippleId), y || (r && r(), FamilyTree.events.publish("redraw", [
                                a
                            ]), a._showAfterAnimation(), y = !0);
                        }, function() {
                            a.xScrollUI.setPosition(), a.yScrollUI.setPosition();
                        }) : !s || !a.response || s[0] == a.response.viewBox[0] && s[1] == a.response.viewBox[1] && s[2] == a.response.viewBox[2] && s[3] == a.response.viewBox[3] || t !== FamilyTree.action.insert && t !== FamilyTree.action.expand && t !== FamilyTree.action.collapse && t !== FamilyTree.action.update && t !== FamilyTree.action.init ? 0 == g[0].length && (y || (r && r(), FamilyTree.events.publish("redraw", [
                            a
                            ...
                            a.xScrollUI.setPosition(), a.yScrollUI.setPosition(), y || (r && r(), FamilyTree.events.publish("redraw", [
                                a
                            ]), y = !0);
                        }), a._initialized || (a._initialized = !0, a.filterUI.update(), FamilyTree.events.publish("init", [
                            a
                        ])), !a._loaded && e && e.nodes && Object.keys(e.nodes).length && (a._loaded = !0);
                    } else {
                        var v = e.boundary, T = v.maxX - v.minX, b = v.maxY - v.minY, F = a.ui.svg(T, b, [
                            v.minX,
                            v.minY,
                            T,
                            b
                ...
                FamilyTree.events.publish("ready", [
                    a,
                    e
                ]);
            });
    ...
    var t = this.getViewBox().slice(0), i = this.width(), r = this.height(), a = i / t[2], n = r / t[3], o = a > n ? n : a, l = t, s = t[2], d = t[3];
    return t[2] = t[2] / (e / o), t[3] = t[3] / (e / o), t[0] = l[0] - (t[2] - s) / 2, t[1] = l[1] - (t[3] - d) / 2, this.setViewBox(t), FamilyTree.events.publish("redraw", [
        this
    ]), e;
    ...
    if (null != r) {
        ...
        if (null != a) {
            ...
            var d = r.w, c = r.h, m = d - o > o ? d - o : o, h = c - l > l ? c - l : l, p = m > h ? m : h, f = document.createElementNS("http://www.w3.org/2000/svg", "g"), u = document.createElementNS("http://www.w3.org/2000/svg", "clipPath"), y = document.createElementNS("http://www.w3.org/2000/svg", "rect"), g = document.createElementNS("http://www.w3.org/2000/svg", "circle"), v = FamilyTree.randomId();
            u.setAttribute("id", v);
            var T = {
    ...
    var m = this.width(), h = this.height(), p = m / (v = n - l + 2 * this.config.padding), f = h / (T = o - s + 2 * this.config.padding), u = p > f ? f : p, y = Math.ceil(m / u), g = Math.ceil(h / u), v = 0, T = 0;
    ...
    if (!0 === i && !1 === FamilyTree.events.publish("update", [
        this,
        a,
        e
    ])) return !1;
    this.update(e), FamilyTree.events.publish("updated", [
        this
    ...
    if (!0 === i && !1 === FamilyTree.events.publish("remove", [
        this,
        e,
        a
    ])) return !1;
    return this.remove(e), FamilyTree.events.publish("updated", [
        this
    ]), this.filterUI.update(), this._draw(!1, FamilyTree.action.update, null, function() {
    ...
    var r = this;
    if (!0 === i && !1 === FamilyTree.events.publish("add", [
        this,
        e
    ])) return !1;
    this.add(e), FamilyTree.events.publish("updated", [
        this
    ]), this.filterUI.update(), r._draw(!1, FamilyTree.action.insert, {
        id: e.pid,
        insertedNodeId: e.id
    }, function() {
        r.ripple(e.id), t && t();
    ...
    if (this.nodes) {
        for(var o in this.nodes)if (!FamilyTree.isNEU(e[o])) {
            n = e[o];
            (l = this.nodes[o]).id = n, this.nodes[n] = l;
        }
    }
    if (this.manager.oldNodes) {
        for(var o in this.manager.oldNodes)if (!FamilyTree.isNEU(e[o])) {
            n = e[o];
            (l = this.manager.oldNodes[o]).id = n, this.manager.oldNodes[n] = l;
        }
    }
    if (this.roots) {
        for(var o in this.roots)if (!FamilyTree.isNEU(e[o])) {
            var l;
            n = e[o];
    ...
    if (!e || FamilyTree.isNEU(e.mid) && FamilyTree.isNEU(e.fid)) console.error("addSonNode invalid data");
        ...
        if (!0 === i) {
            if (!1 === FamilyTree.events.publish("update", [
                this,
                a
            ])) return !1;
        }
        ...
        FamilyTree.isNEU(a.addNodesData[0].pid) ? FamilyTree.isNEU(a.addNodesData[0].mid) ? FamilyTree.isNEU(a.addNodesData[0].fid) || (n = a.addNodesData[0].fid) : n = a.addNodesData[0].mid : n = a.addNodesData[0].pid, r._draw(!1, FamilyTree.action.insert, {
            ...
            r.ripple(a.addNodesData[0].id), t && t(), !0 === i && FamilyTree.events.publish("updated", [
                r,
                a
            ]), r.filterUI.update();
        });
    ...
    if (!t || FamilyTree.isNEU(t.mid) && FamilyTree.isNEU(t.fid)) console.error("addChildAndPartnerNodes invalid childData");
        ...
        l ? c = l.id : FamilyTree.isNEU(t.pid) ? FamilyTree.isNEU(t.mid) ? FamilyTree.isNEU(t.fid) || (c = t.fid) : c = t.mid : c = t.pid, n._draw(!1, FamilyTree.action.update, {
            ...
            n.ripple(t.id), n.ripple(i.id), r && r(), !0 === a && FamilyTree.events.publish("updated", [
                n,
                s
            ]), n.filterUI.update();
        }), !0 === a && FamilyTree.events.publish("updating", [
            n,
            s
        ]);
    ...
    if (!FamilyTree.isNEU(t) && t.length) {
        if (i) {
            ...
            d && (h = d.id), n._draw(!1, FamilyTree.action.update, {
                ...
                n.ripple(i.id), r && r(), !0 === a && FamilyTree.events.publish("updated", [
                    n,
                    c
                ]), n.filterUI.update();
            }), !0 === a && FamilyTree.events.publish("updating", [
    ...
    if (e && Array.isArray(e.pids) && 1 == e.pids.length) {
        ...
        r._draw(!1, FamilyTree.action.insert, {
            ...
            r.ripple(n.addNodesData[0].id), t && t(), !0 === i && FamilyTree.events.publish("updated", [
                r,
                n
            ]), r.filterUI.update();
        }), !0 === i && FamilyTree.events.publish("updating", [
            r,
            n
        ]);
        ...
        if ([
            ...
            if (FamilyTree.isNEU(e)) console.error("addParentNode invalid childId");
                ...
                n.config.roots = [
                    ...
                    n.ripple(d.addNodesData[0].id), r && r(), !0 === a && FamilyTree.events.publish("updated", [
                        n,
                        d
                    ]), n.filterUI.update();
                }), !0 === a && FamilyTree.events.publish("updating", [
    ...
    var t = this.getNode(e);
    if (!t) return !1;
    var i = this.getNode(t.mid), r = this.getNode(t.fid), a = t.ftChildrenIds.length > 0, n = !1, o = t.pids.length > 0, l = t.pids.length > 1;
    if (1 == t.pids.length) {
    ...
    if (this.canRemove(e)) {
        ...
        r._fireUpdate_addUpdateRemove(c, i), -1 != (d = r.config.roots.indexOf(e)) && r.config.roots.splice(d, 1), r._draw(!1, FamilyTree.action.update, null, function() {
            r.config.sticky && FamilyTree._moveToBoundaryArea(r.getSvg(), r.getViewBox(), r.response.boundary), t && t(), !0 === i && FamilyTree.events.publish("updated", [
                r,
                c
            ]), r.filterUI.update();
        }), !0 === i && FamilyTree.events.publish("updating", [
    ...
    FamilyTree.isNEU(e.removeNodeId) || this.remove(e.removeNodeId), !0 === t && FamilyTree.events.publish("updating", [
        this,
        e
    ]);
    ...
    return Array.isArray(e) || (e = [
        ...
        for(var m = 0; m < e.length; m++)for(var h in i[m]){
            ...
            switch(h.toLowerCase()){
                case "d":
                    var f = a((d * s - s) / r) * (i[m][h][0] - t[m][h][0]) + t[m][h][0], u = a((d * s - s) / r) * (i[m][h][1] - t[m][h][1]) + t[m][h][1];
    ...
    return e < 0 ? 0 : e > 1 ? 1 : e < 1 ? -0.5 * (Math.sqrt(1 - e * e) - 1) : .5 * (Math.sqrt(1 - (2 * e - 2) * (2 * e - 2)) + 1);
    ...
    var n, o, l;
    return "left" == a ? n = e.leftNeighbor ? e.x + (e.leftNeighbor.x + e.leftNeighbor.w - e.x) / 2 : e.x - i.siblingSeparation / 2 : "right" == a && (n = e.rightNeighbor ? e.x + e.w + (e.rightNeighbor.x - (e.x + e.w)) / 2 : e.x + e.w + i.siblingSeparation / 2), t.push([
        n,
        t[t.length - 1][1]
    ]), t.push([
        n,
        e.y - i.levelSeparation / 3
    ]), o = t[t.length - 1][1], l = n, r.p = n, r.q = o, r.r = l, r;
    ...
    return "left" == a ? n = e.leftNeighbor ? e.x + (e.leftNeighbor.x + e.leftNeighbor.w - e.x) / 2 : e.x - i.siblingSeparation / 2 : "right" == a && (n = e.rightNeighbor ? e.x + e.w + (e.rightNeighbor.x - (e.x + e.w)) / 2 : e.x + e.w + i.siblingSeparation / 2), t.push([
        ...
        n,
        e.y + e.h + i.levelSeparation / 3
    ]), o = t[t.length - 1][1], l = n, r.p = n, r.q = o, r.r = l, r;
}, FamilyTree._addPointLeft = function(e, t, i, r, a) {
    var n, o = t[t.length - 1][0];
    "bottom" == a ? n = e.rightNeighbor ? e.y + e.h + (e.rightNeighbor.y - (e.y + e.h)) / 2 : e.y + e.h + i.siblingSeparation / 2 : "top" == a && (n = e.leftNeighbor ? e.y + (e.leftNeighbor.y + e.leftNeighbor.h - e.y) / 2 : e.y - i.siblingSeparation / 2), t.push([
        t[t.length - 1][0],
        n
    ]), t.push([
        e.x - i.levelSeparation / 3,
        n
    ]), o = t[t.length - 1][0];
    var l = n;
    ...
    if (this.hide(), !1 === FamilyTree.events.publish("show", [
        this,
        e
    ])) return !1;
    ...
    this.obj.element.appendChild(a.element), FamilyTree.input.init(this.obj.element), i ? t || this._focusElement(a.focusId) : this.interval = FamilyTree.animate(a.element, {
        ...
        t.preventDefault(), !1 !== FamilyTree.events.publish("cancel", [
            r,
            {
                id: e
            }
        ...
        if (!1 !== i) {
            ...
            if (!1 === FamilyTree.events.publish("save", [
                r,
                o
            ])) return;
    ...
    for(var n = this.obj.element.querySelectorAll("[data-input-btn]"), o = 0; o < n.length; o++)n[o].addEventListener("click", function(t) {
        t.preventDefault(), FamilyTree.events.publish("element-btn-click", [
            r,
            {
    ...
    this.obj.element.querySelector("[data-add-more-fields-btn]").addEventListener("click", function(e) {
        ...
        a.focus(), a.nextElementSibling.addEventListener("click", function(e) {
            e.stopPropagation(), e.preventDefault();
            var i = a.value, n = r.obj.element.querySelector('[data-binding="' + FamilyTree._escapeDoubleQuotes(a.value) + '"]');
        ...
        if (i && i.hasAttribute) {
            var n = i.getAttribute("data-edit-from-btn"), o = {
                button: r.obj.config.editForm.buttons[n],
                name: n,
                nodeId: e,
                event: t
            };
            if (!1 === FamilyTree.events.publish("button-click", [
                r,
                o
            ])) return !1;
            switch(n){
    ...
    var w = !t, k = t ? "display:none;" : "", S = t || !s ? "display:none;" : "", C = y.editFormHeaderColor ? `style="background-color:${y.editFormHeaderColor};"` : "", I = document.createElement("form");
    if (I.setAttribute("data-bft-edit-form", ""), I.classList.add("bft-edit-form"), I.classList.add(this.obj.config.mode), I.classList.add(f.templateName.replaceAll(" ", "")), I.classList.add(FamilyTree.ui._defsIds[f.templateName]), Array.isArray(f.tags) && f.tags.length) for(T = 0; T < f.tags.length; T++)I.classList.add(f.tags[T].replaceAll(" ", ""));
    ...
    if (!1 === FamilyTree.events.publish("hide", [
        this
    ])) return !1;
    ...
    if (!1 === FamilyTree.events.publish("show", [
        this,
        l
    ])) return !1;
    ...
    if ("" != o) {
        ...
        for(var f = this.wrapper.getElementsByTagName("div"), u = 0; u < f.length; u++)(s = f[u]).addEventListener("click", function(e) {
    ...
    if (!FamilyTree.isNEU(a.nodeCircleMenuButton)) {
        ...
        if (FamilyTree.isNEU(p) || p.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id) != e) {
            ...
            var f = {
                nodeId: e,
                menu: t
            }, u = FamilyTree.events.publish("show", [
                this,
                f
            ]);
            ...
            for(var F in (p = document.createElementNS("http://www.w3.org/2000/svg", "g")).setAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id, e), p.setAttribute("transform", "matrix(1,0,0,1," + c + "," + m + ")"), n.appendChild(p), f.menu){
                ...
                this._buttonsInterval.push(FamilyTree.animate(k, {
                    ...
                    var t = e[0].getAttribute(FamilyTree.attr.control_node_circle_menu_name), r = e[0].parentNode.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id);
    ...
    if (null != t) {
        var i = t.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id), r = this.obj.getNode(i), a = FamilyTree.t(r.templateName, r.min, this.obj.getScale()), n = this.obj.element.querySelector("[" + FamilyTree.attr.control_node_circle_menu_id + '="' + i + '"]').querySelectorAll("line");
    ...
    FamilyTree.idb._open(function(i) {
        if (i) {
            var r = FamilyTree.idb.db.transaction([
                FamilyTree.idb.tableName
            ]).objectStore(FamilyTree.idb.tableName).get(e);
    ...
    FamilyTree.idb.read(e.id, function(i) {
        if (null == i) {
            var r = FamilyTree.idb.db.transaction([
                FamilyTree.idb.tableName
            ], "readwrite").objectStore(FamilyTree.idb.tableName).add(e);
            r.onerror = function(e) {
    ...
    FamilyTree.idb._open(function(i) {
        if (i) {
            var r = FamilyTree.idb.db.transaction([
                FamilyTree.idb.tableName
            ], "readwrite").objectStore(FamilyTree.idb.tableName).put(e);
            r.onerror = function(e) {
    ...
    FamilyTree.idb._open(function(i) {
        if (i) {
            var r = FamilyTree.idb.db.transaction([
                FamilyTree.idb.tableName
            ], "readwrite").objectStore(FamilyTree.idb.tableName).delete(e);
            r.onerror = function(e) {
                console.error("Unable to retrieve data from database!"), t && t(!1);
            }, r.onsuccess = function(e) {
                r.error ? t && t(!1) : t && t(!0);
    ...
    if (t) {
        ...
        var i = this.div.querySelector("[" + FamilyTree.attr.tlbr + '="plus"]'), r = this.div.querySelector("[" + FamilyTree.attr.tlbr + '="minus"]'), a = this.div.querySelector("[" + FamilyTree.attr.tlbr + '="fit"]'), n = this.div.querySelector("[" + FamilyTree.attr.tlbr + '="fullScreen"]'), o = this.div.querySelector("[" + FamilyTree.attr.tlbr + '="expand"]'), l = this;
    ...
    var a = FamilyTree._getTopLeft(e), n = r.touches[0].pageX - a.x, o = r.touches[0].pageY - a.y, l = r.touches[1].pageX - a.x, s = r.touches[1].pageY - a.y;
    return [
        ((n - l) / 2 + l) / (t / 100),
        ((o - s) / 2 + s) / (i / 100)
    ];
}, FamilyTree._browser = function() {
    var e = !!window.opr && !!window.opr.addons || !!window.opera || navigator.userAgent.indexOf(" OPR/") >= 0, t = "undefined" != typeof InstallTrigger, i = /constructor/i.test(window.HTMLElement) || "[object SafariRemoteNotification]" === (!window.safari || void 0 !== window.safari && safari.pushNotification).toString(), r = !!document.documentMode, a = !r && !!window.StyleMedia, n = !(!window.chrome || !window.chrome.webstore && !window.chrome.runtime);
    return {
        opera: e,
        firefox: t,
        safari: i,
    ...
    var r = e.getBoundingClientRect(), a = i.getBoundingClientRect(), n = t.getBoundingClientRect(), o = r.left - a.left, l = r.top - a.top;
    ...
    if (-1 != m.indexOf("multiline")) {
        var g = e.split(" "), v = p.getBBox().height;
        p.textContent = "";
        var T = document.createElementNS(h, "tspan"), b = document.createTextNode(g[0]);
    ...
    for(var i = 0, r = 0; r < t.childrenIds.length; r++)e.nodes[t.childrenIds[r]] && i++;
    return i;
    ...
    Array.isArray(e) || (e = (e = e.split(/[,\s]/).reduce(function(e, t) {
        ...
        return parseFloat(t) == t && e.length ? e[e.length - 1].push(t) : e.push([
            t
        ]), e;
    }, []));
    var l = [];
    if (e.length > 1) {
        var s = o(e[0]), d = null;
        "Z" == e[e.length - 1][0] && e[0].length > 2 && (d = [
            "L",
            s.x,
            s.y
        ], e[e.length - 1] = d), l.push(e[0]);
        for(var c = 1; c < e.length; c++){
            var m = l[l.length - 1], h = e[c], p = h == d ? e[1] : e[c + 1];
    ...
    return null == e && (e = {}), "svg" == t ? (e.ext = "svg", e.mime = "image/svg+xml") : "pdf" == t ? (e.mime = "application/pdf", e.ext = "pdf") : "png" == t && (e.mime = "image/png", e.ext = "png"), null == e.margin && (e.margin = [
        50,
        40,
        50,
        40
    ]), null == e.padding && (e.padding = 0), null == e.landscape && (e.landscape = !1), null == e.filename && (e.filename = "FamilyTree." + e.ext), null == e.scale && (e.scale = "fit"), null == e.format && (e.format = "fit"), null == e.header && (e.header = ""), "pdf" == t && null == e.footer ? e.footer = "Page {current-page} of {total-pages}" : null == e.footer && (e.footer = ""), null == e.openInNewTab && (e.openInNewTab = !1), null == e.mode && (e.mode = "bft-" + this.config.mode), e;
    ...
    e.margin && e.margin[0] < 2 && (e.margin[0] = 2), e.margin && e.margin[1] < 2 && (e.margin[1] = 2), e.margin && e.margin[2] < 2 && (e.margin[2] = 2), e.margin && e.margin[3] < 2 && (e.margin[3] = 2), this._draw(!1, FamilyTree.action.exporting, r, function(r, a) {
        ...
        if (n.innerHTML = r, e.padding > 0) {
            var o = n.querySelector("svg"), l = FamilyTree._getViewBox(o);
        ...
        if ("svg" == e.ext) {
            if (t) t(e, n.innerHTML);
                ...
                if (!1 === (d = FamilyTree.events.publish("exportend", [
                    i,
                    s
                ]))) return !1;
    ...
    if (!1 === FamilyTree.events.publish("exportstart", [
        this,
        a
    ])) return !1;
    var n = FamilyTree._json2csv(a.nodes), o = {
        ext: a.ext,
        filename: a.filename,
        options: t,
        nodes: a.nodes,
    ...
    if (!1 === FamilyTree.events.publish("exportend", [
        this,
        o
    ])) return !1;
    ...
    var n = FamilyTree._json2xml(a.nodes), o = {
        ext: a.ext,
        filename: a.filename,
        options: t,
        nodes: a.nodes,
    ...
    var i = t.getAttribute("width"), r = t.getAttribute("height"), a = FamilyTree._getViewBox(t), n = {
        w: parseFloat(i),
        h: parseFloat(r)
    };
    return [
    ...
    var r = t.getAttribute("width"), a = 0, n = 0;
    switch(e.format){
        case "A5":
    ...
    var o = e.landscape ? n - (e.margin[1] + e.margin[3]) : a - (e.margin[1] + e.margin[3]), l = (e.landscape ? (e.margin[0], e.margin[2]) : (e.margin[0], e.margin[2]), o / r);
    return this._pagesA100(e, t, 100 * l, i);
}, FamilyTree.prototype._pagesA100 = function(e, t, i, r) {
    var a = FamilyTree._getViewBox(t), n = 0, o = 0;
    switch(e.format){
        case "A5":
    ...
    var p = m.w * (100 / i), f = m.h * (100 / i), u = l, y = s, g = [], v = !0;
    ...
    if (!v || FamilyTree.EXPORT_PAGES_CUT_NODES || "fit" != e.scale) for(t.setAttribute("preserveAspectRatio", "xMinYMin slice"), g = []; u < d + l;){
        for(; y < c + s;){
            var C;
            C = (C = [
                u,
    ...
    return FamilyTree.isNEU(e) || null == e.id || null != e.nodeId || (e.nodeId = e.id), (FamilyTree.isNEU(e) || FamilyTree.isNEU(e.nodeId)) && console.error("options.nodeId is not defilned"), "svg" == t ? (e.ext = "svg", e.mime = "image/svg+xml") : "pdf" == t ? (e.mime = "application/pdf", e.ext = "pdf") : "png" == t && (e.mime = "image/png", e.ext = "png"), null == e.margin && (e.margin = [
        50,
        40,
        50,
        40
    ]), null == e.padding && (e.padding = 0), null == e.landscape && (e.landscape = !1), null == e.filename && (e.filename = "Profile." + e.ext), null == e.scale && (e.scale = "fit"), null == e.format && (e.format = "A4"), null == e.header && (e.header = ""), null == e.footer && (e.footer = ""), null == e.openInNewTab && (e.openInNewTab = !1), null == e.mode && (e.mode = "bft-" + this.config.mode), e;
    ...
    s = JSON.stringify(s), FamilyTree._ajax(this.config.exportUrl + "/v3", "POST", s, "arraybuffer", function(r) {
        if (t) t(i, r);
            ...
            var a = FamilyTree.events.publish("exportend", [
                i,
                r
            ]);
    ...
    t.setAttribute("type", "file"), t.setAttribute("accept", ".csv"), t.style.display = "none", t.onchange = function(t) {
        ...
        r.onload = function() {
            ...
            FamilyTree._importSetColumnNames(n, function(t) {
                ...
                0 != FamilyTree.events.publish("import", [
                    e,
                    d
                ]) && (e._putInUndoStack(), e.clearRedo(), e.config.nodes = d.nodes, FamilyTree.events.publish("updated", [
                    e
                ]), e.filterUI.update(), e.draw());
            });
    ...
    if (-1 == e.indexOf("id") || -1 == e.indexOf("pid")) {
        ...
        b.innerHTML = "Import", b.style.fontSize = "16px", b.style.color = "rgb(122, 122, 122)", b.style.padding = "5px 20px", b.style.margin = "20px auto", b.style.display = "block", b.onclick = function() {
            ...
            var i = h.options[h.selectedIndex].value, r = e.indexOf(i);
            e[r] = "id";
    ...
    t.setAttribute("type", "file"), t.setAttribute("accept", ".xml"), t.style.display = "none", t.onchange = function(t) {
        ...
        r.onload = function() {
            ...
            0 != FamilyTree.events.publish("import", [
                e,
                i
            ]) && (e._putInUndoStack(), e.clearRedo(), e.config.nodes = i, FamilyTree.events.publish("updated", [
                e
            ]), e.filterUI.update(), e.draw());
        }, r.readAsText(i.files[0]);
    }, t.click();
    ...
    if (FamilyTree.RESET_MOVABLE_ONEXPANDCOLLAPSE && null != this.config.movable) {
        ...
        e && FamilyTree.events.publish("updated", [
            this
        ]);
    }
    ...
    if (i.length) {
        if (!1 === FamilyTree.events.publish("expcollclick", [
            this,
            !1,
            e,
            i
    ...
    if (!1 === FamilyTree.events.publish("up-click", [
        this,
        t
    ])) return !1;
    ...
    if (-1 != t.type.indexOf("touch") && this._touch && 1 == t.changedTouches.length) {
        if (t.changedTouches.length) {
            ...
            }, r = FamilyTree.t(this.config.template, !1, this.getScale()).size, a = this.getScale(), n = Math.abs(i.x - this._touch.x) / a, o = Math.abs(i.y - this._touch.y) / a;
    ...
    for(var l = t.target; l != e;){
        ...
        if (l.hasAttribute(FamilyTree.attr.c_link_from)) return void FamilyTree.events.publish("clink-click", [
            this,
            {
        ...
        if (l.hasAttribute(FamilyTree.attr.s_link_from)) return void FamilyTree.events.publish("slink-click", [
            this,
            {
    ...
    var i = this, r = !1, a = this.config.zoom.speed, n = this.config.zoom.smooth, o = 0, l = this.getScale(), s = FamilyTree._centerPointInPercent(e, t.pageX, t.pageY);
    ...
    var r = e.parentNode.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id), a = e.getAttribute(FamilyTree.attr.control_node_circle_menu_name), n = this.nodeCircleMenuUI._menu[a];
    if (n.draggable) {
        ...
        var T = function(e, t) {
            ...
            if (p) {
                ...
                if (s.left || s.right || s.up || s.down) {
                    ...
                    var b = u[4], x = u[5], _ = p.x, w = p.y, k = i.x, S = i.y;
                    ...
                    var E = (i.x - p.x) / d, M = (i.y - p.y) / d;
                    if (u[4] = y + E, u[5] = g + M, !e._dragEventFired && (Math.abs(i.x - p.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - p.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)) !1 === FamilyTree.events.publish("drag", [
                        o.nodeCircleMenuUI,
                        {
                            from: C,
                            menuItem: n,
            ...
            if (o.moveEnd(), h.classList && (h.classList.remove("bft-cursor-grab"), h.classList.remove("bft-cursor-move"), h.classList.remove("bft-cursor-nodrop"), h.classList.remove("bft-cursor-copy")), h.removeEventListener(i.move, b), h.removeEventListener(i.up, F), i.leave && h.removeEventListener(i.leave, F), s.id == c || null == c) return h.removeChild(f), o._gragStartedId = null, void (e._dragEventFired && FamilyTree.events.publish("drop", [
                o.nodeCircleMenuUI,
                {
                    from: s.id,
                    menuItemName: a,
    ...
    var r = e.getAttribute(FamilyTree.attr.node_id), a = this.getNode(r);
    ...
    var r = this, a = e.getAttribute(FamilyTree.attr.node_id), n = [], o = function(e, t) {
    ...
    var C = {
        ...
        if (C) {
            var i = FamilyTree._getClientXY(t), o = t.target;
            FamilyTree.isMobile() && (o = document.elementFromPoint(i.x, i.y));
            var l = FamilyTree._getOffsetXY(r.element, t), c = {
            ...
            if (c.left || c.right || c.up || c.down) {
                ...
                var w = C.x, A = C.y, E = i.x, M = i.y;
                r.moveStart(c, function(e) {
                    for(var t = 0; t < h.length; t++){
                        var a = T[t], n = b[t], o = F[t], l = x[t];
                        ...
                        if (m[t].parent) for(s = FamilyTree.ui.link(m[t].parent, r, I, r.response.bordersByRootIdAndLevel, r.nodes, FamilyTree.action.update, !0), d = 0; d < s.length; d++){
                            var p;
                            c = s[d];
                            (p = r.element.querySelector(`[data-l-id="[${c.id}][${c.childId}]"]`)) && (p.innerHTML = c.html);
                        }
                ...
                if (r.moveEnd(), d.classList && (d.classList.add("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-nodrop"), d.classList.remove("bft-cursor-copy")), N(k, S), k = null, S = null, r.config.enableDragDrop) for(; null != o && o != d;){
                ...
                if (s.parent) {
                    ...
                    else for(z = FamilyTree.ui.link(s.parent, r, I, r.response.bordersByRootIdAndLevel, r.nodes, FamilyTree.action.update, !0), R = 0; R < z.length; R++){
                        var j;
                        $ = z[R];
                        (j = r.element.querySelector(`[data-l-id="[${$.id}][${$.childId}]"]`)) && (j.innerHTML = $.html);
                    }
                ...
                if (!e._dragEventFired && (Math.abs(i.x - C.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - C.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)) {
                    if (!1 === FamilyTree.events.publish("drag", [
                        r,
                        a,
                        t,
                        n
                    ]) && L(), r.config.enableDragDrop) for(_ = 0; _ < u.length; _++)d.insertBefore(u[_], d.firstChild);
                    e._dragEventFired = !0;
                }
        ...
        if (r.moveEnd(), d.classList && (d.classList.remove("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-nodrop"), d.classList.remove("bft-cursor-copy")), d.removeEventListener(i.move, A), d.removeEventListener(i.up, L), i.leave && d.removeEventListener(i.leave, L), m[0].id != k && null != k) {
            var n = r.getNode(k);
            if (!1 === (o = FamilyTree.events.publish("drop", [
                r,
                m[0].id,
                n.id,
                u[0],
            ...
            if (e._dragEventFired) {
                ...
                if (r.config.movable && !1 !== o) {
                    if (r.config.movable == FamilyTree.movable.detachTree) {
                        ...
                        var f = (c = FamilyTree._getTransform(r.getNodeElement(s.id)))[4] - s.x, y = c[5] - s.y;
    ...
    var s = this, d = this.getSvg(), c = {
        x: r.x,
        y: r.y
    }, m = FamilyTree._getTransform(e), h = m[4], p = m[5], f = s.getScale(), u = e.cloneNode(!0);
    ...
    var y = function(e, t) {
        ...
        if (c) {
            ...
            if (g.left || g.right || g.up || g.down) {
                ...
                if (m[4] = h + A, m[5] = p + L, !e._dragEventFired && (Math.abs(i.x - c.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - c.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)) !1 === FamilyTree.events.publish("drag", [
                    s,
                    k,
                    t
                ]) && v(), e._dragEventFired = !0;
                u.setAttribute("transform", "matrix(" + m.toString() + ")");
            }
        }
    }, v = function(t) {
        if (s.moveEnd(), d.classList && (d.classList.remove("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-nodrop"), d.classList.remove("bft-cursor-copy")), d.removeEventListener(i.move, g), d.removeEventListener(i.up, v), i.leave && d.removeEventListener(i.leave, v), n.id == o || null == o) return e._dragEventFired && FamilyTree.events.publish("drop", [
            s,
            n.id,
            void 0,
            u,
        ...
        var r = s.getNode(o);
        if (!1 === FamilyTree.events.publish("drop", [
            s,
            n.id,
            r.id,
            u,
    ...
    if (this.isVisible) {
        var i = this.getViewBox(), r = this.getSvg(), a = r.getAttribute("width"), n = r.getAttribute("height"), o = a / i[2], l = n / i[3], s = o > l ? l : o;
    ...
    if (!1 === FamilyTree.events.publish("dbclick", [
        this,
        this.get(e)
    ])) return !1;
    ...
    if (i && i._dragEventFired) i._dragEventFired = !1;
        ...
        if (!1 === FamilyTree.events.publish("click", [
            this,
            {
                node: this.getNode(e),
                event: t
    ...
    var i = e.parentNode.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id), r = e.getAttribute(FamilyTree.attr.control_node_circle_menu_name), a = this.nodeCircleMenuUI._menu[r];
    ...
    if (e) {
        if (!this._moveInterval) {
            ...
            FamilyTree.isNEU(i) && (i = FamilyTree.anim.inSin), FamilyTree.isNEU(r) && (r = 3e3), this._moveInterval = setInterval(function() {
                ...
                var m = i((10 * d - 10) / r);
                c.x = c.x * m, c.xWithoutScale = c.xWithoutScale * m, c.y = c.y * m, c.yWithoutScale = c.yWithoutScale * m, a.setViewBox([
                    n[0] + c.x,
                    n[1] + c.y,
                    n[2],
                    n[3]
    ...
    var a = this.getViewBox(), n = this.getScale(), o = FamilyTree._getClientTouchesXY(t, 0), l = FamilyTree._getClientTouchesXY(t, 1), s = {
        diffX: 0,
        diffY: 0,
        x0: o.x,
        y0: o.y,
    ...
    var d = function(e) {
        ...
        if (s && "pan" == s.type) {
            ...
            var l = FamilyTree._getClientTouchesXY(e, 1), d = Math.sqrt((t.x - l.x) * (t.x - l.x) + (t.y - l.y) * (t.y - l.y)), c = 1 + (d - s.dist) / (s.dist / 100) / 100;
            s.dist = d;
    ...
    var r = this.getPointerElement(), a = FamilyTree._getOffsetXY(this.element, i), n = a.x / t + e[0] - 16 / t, o = a.y / t + e[1] - 16 / t;
    ...
    var t = this, i = this.instance.config.padding - 10, r = this.instance.config.padding - 10, a = this.instance.getMenuButton();
    if (a) {
    ...
    var c = function() {
        var e = t.instance.element.querySelectorAll("[data-search-item-id]"), i = t.instance.element.querySelector('[data-selected="yes"]');
    ...
    if (e) {
        if (e.hasAttribute("data-search-item-id")) {
            ...
            if (this.input.value != FamilyTree.SEARCH_HELP_SYMBOL) {
                var i = FamilyTree.events.publish("", [
                    this.instance,
                    t
    ...
    FamilyTree.state._get(this.config.state, t, i, function(d) {
        ...
        var c = s.maxX, m = s.maxY, h = s.minX, p = s.minY, f = s.bordersByRootIdAndLevel, u = s.roots, y = s.nodes;
        if (e) {
    ...
    null == o && (o = FamilyTree.local), o._setPositions(n, i.layoutConfigs, function(t) {
        ...
        for(var m in d)for(var h in d[m]){
            var p = s[m][h], f = d[m][h];
    ...
    var l = o.manager.config, s = o.manager.layoutConfigs, d = o.manager.action, c = o.manager.actionParams, m = o.manager.state, h = s[i || "base"];
    ...
    if (d != FamilyTree.action.minimize || e.min ? d == FamilyTree.action.maximize && !0 === e.min ? (c.all || c.id == e.id) && (e.min = !1) : d == FamilyTree.action.exporting && !1 === c.min ? e.min = !1 : d == FamilyTree.action.init && null != m && (e.min = m.min.has(e.id)) : (c.all || c.id == e.id) && (e.min = !0), !e.min) for(p = 0; p < e.stChildrenIds.length; p++){
    ...
    e.w = g && g.size ? g.size[0] : 0, e.h = g && g.size ? g.size[1] : 0, e.padding = g && g.padding ? g.padding : [
        0,
        0,
        0,
        0
    ...
    FamilyTree.events.publish("node-initialized", [
        o,
        v
    ]);
    ...
    if (FamilyTree.manager._initNode(t, i, s, r, d, c, m), t.isAssistant && (n[t.pid] || (n[t.pid] = []), n[t.pid].push(t.id)), t.subLevels > 0 && o.push(t.id), FamilyTree.MIXED_LAYOUT_FOR_NODES_WITH_COLLAPSED_CHILDREN && !t.isAssistant && t.parent) {
        if (t.parent && t.parent.children.length && t.parent.children[t.parent.children.length - 1] == t) {
            for(var p = [], f = 0, u = 0, y = 0; y < t.parent.children.length; y++)-1 == (g = t.parent.children[y]).tags.indexOf("partner") && -1 == g.tags.indexOf("left-partner") && -1 == g.tags.indexOf("right-partner") && -1 == g.tags.indexOf("assistant") && 0 == g.children.length ? p.push(g.id) : -1 != g.tags.indexOf("assistant") ? f++ : -1 == g.tags.indexOf("partner") && -1 == g.tags.indexOf("left-partner") && -1 == g.tags.indexOf("right-partner") || u++;
    ...
    for(var v = 0; v < t.stChildren.length; v++){
        var T = "";
        for(y = 0; y < t.tags.length; y++)if (h[t.tags[y]]) {
            T = t.tags[y];
            break;
        }
    ...
    for(var s = [], d = FamilyTree._addDottedLines(i), c = 0; c < d.length; c++){
        ...
        var f = FamilyTree._getTemplate(m, i.tags, i.template), u = new FamilyTree.node(h.id, h.pid, m, f);
    ...
    var t = e.manager.config, i = e.manager.layoutConfigs, r = e.manager.action, a = e.manager.actionParams, n = e.manager.oldNodes, o = e.manager.state, l = {}, s = [], d = [];
    ...
    r == FamilyTree.action.exporting && null != a.id && (g = l[a.id]) && (g.pid = null, s = [
        g
    ]);
    var y = [];
    if (r == FamilyTree.action.init && t.expand && t.expand.nodes && null == o) for(c = 0; c < t.expand.nodes.length; c++){
        ...
        for(var T = l[a.id]; T;){
            if (y.push(T.id), a.options.parentState === FamilyTree.COLLAPSE_PARENT_NEIGHBORS && T) for(c = 0; c < T.childrenIds.length; c++)(D = l[T.childrenIds[c]]).collapsed = !0;
        ...
        if (a.options.childrenState === FamilyTree.COLLAPSE_SUB_CHILDRENS) for(c = 0; c < T.childrenIds.length; c++){
            ...
            for(var b = 0; b < F.childrenIds.length; b++)l[F.childrenIds[b]].collapsed = !0;
        }
        if (a.options.parentState === FamilyTree.COLLAPSE_PARENT_SUB_CHILDREN_EXCEPT_CLICKED) {
            if (v = l[T.pid]) for(c = 0; c < v.childrenIds.length; c++){
                var F;
                if ((F = l[v.childrenIds[c]]) != T) {
                    F.collapsed = !1;
                    for(b = 0; b < F.childrenIds.length; b++)l[F.childrenIds[b]].collapsed = !0;
                }
            }
        }
    ...
    if (r == FamilyTree.action.collapse && a && Array.isArray(a.expandIds) && Array.isArray(a.collapseIds)) for(c = 0; c < a.ids.length; c++)if (a.expandIds.has(a.collapseIds[c])) console.error(`id ${a.collapseIds[c]} exist in both collapseIds and expandIds`);
    else (g = l[a.collapseIds[c]]) && (g.collapsed = !0);
    for(c = s.length - 1; c >= 0; c--)s[c].collapsed && s.splice(c, 1);
    for(c = 0; c < S.length; c++){
        g = l[S[c]];
        var C = [], I = [], N = [], A = {}, L = 0, E = 0, M = 0, O = [], U = [];
        for(b = 0; b < g.children.length; b++)(D = g.children[b]).isAssistant ? C.push(D.id) : -1 != D.tags.indexOf("right-partner") ? (D.isPartner = 1, D.children = [], I.push(D.id)) : -1 != D.tags.indexOf("left-partner") ? (D.isPartner = 2, D.children = [], N.push(D.id)) : -1 == D.tags.indexOf("partner") || L % 2 ? -1 != D.tags.indexOf("partner") && L % 2 ? (D.isPartner = 2, D.children = [], N.push(D.id), L++) : D.parentPartner ? (A[D.parentPartner.id] || (A[D.parentPartner.id] = []), A[D.parentPartner.id].push(D.id)) : C.push(D.id) : (D.isPartner = 1, D.children = [], I.push(D.id), L++);
        g.children = [];
        var B = [];
        ...
        for(b = 0; b < P.length; b++)(D = l[P[b]]).collapsed || (D.parentPartner = D.parent, D.parent = g, D.isChildOfPartner = !0, g.children.push(D));
        for(b = N.length - 1; b >= 0; b--)if (A[N[b]]) for(u = 0; u < A[N[b]].length; u++)g.children.push(l[A[N[b]][u]]), E++, -1 == U.indexOf(N[b]) && U.push(N[b]);
        for(b = 0; b < C.length; b++){
            var D = l[C[b]];
            g.children.push(D);
        }
        for(b = 0; b < I.length; b++)if (A[I[b]]) for(u = 0; u < A[I[b]].length; u++)g.children.push(l[A[I[b]][u]]), M++, -1 == O.indexOf(I[b]) && O.push(I[b]);
        for(b = 0; b < B.length; b++)(D = l[B[b]]).collapsed || (D.parentPartner = D.parent, D.parent = g, D.isChildOfPartner = !0, g.children.push(D));
    ...
    for(var $ in _){
        (v = l[$]).hasAssistants = !0;
        z = new FamilyTree.node(v.id + "_split_assitant_0", v.id, [
            "assistant"
        ], "split");
        FamilyTree.manager._initDinamicNode(z, v.lcn, !0), l[z.id] = z;
        var j = [];
        for(b = v.children.length - 1; b >= 0; b--)(D = v.children[b]).isAssistant ? (D.parent = null, v.children.splice(b, 1), j.splice(0, 0, D.id)) : D.isPartner || (D.parent && k[D.parent.id] && z && D.parent.id != z.id && (Object.defineProperty(k, z.id, Object.getOwnPropertyDescriptor(k, D.parent.id)), delete k[D.parent.id]), D.parent = z, z.children.unshift(D), v.children.splice(b, 1));
        if (j.length % 2) {
            var Y = l[j[j.length - 1]], X = new FamilyTree.node(Y.id + "_mirror", v.pid, [], "mirror");
    ...
    if (Z || ee) {
        ...
        if (w.length) {
            ...
            for(var $ in k){
                var re = k[$];
                for(c = 0; c < re.length; c++)if ((g = l[re[c]]).subLevels) {
                    ie = !0;
                    break;
                }
                if (ie) break;
        ...
        for(var $ in k){
            ...
            if (0 != (H = i[v.lcn ? v.lcn : "base"]).layout || ee) {
                te.pnode = v, te.layout = H.layout, te.layoutGridColumns = t.layoutGridColumns, te.childrenIds = k[$], te.lastChildrenPidIds = k, te.subLevels = 0, te.layouts = [], FamilyTree.events.publish("node-layout", [
                    e,
                    te
                ]), FamilyTree.events.publish("layout", [
                    te
                ...
                for(var he = 0; he < te.layouts.length; he++){
                    ...
                    if (pe.layout == FamilyTree.layout.grid && pe.childrenIds.length > 2) {
                        ...
                        var ye = v.id;
                        for(c = v.children.length - 1; c >= 0; c--)for(b = 0; b < pe.childrenIds.length; b++){
                            de = pe.childrenIds[b];
                    ...
                    if (pe.layout == FamilyTree.layout.mixed) {
                        ...
                        for(q = 1, b = xe.length - 1; b >= 0; b--)if (b % 2 && b != xe.length - 1) {
    ...
    return FamilyTree.events.publish("nodes-initialized", [
        e,
        te
    ]), {
        nodes: te.nodes,
    ...
    if (null != e.x && null != e.y) {
        if (t.lazyLoading && r !== FamilyTree.action.exporting) {
            function a(e, t) {
                var i = e.x, r = e.y, a = e.w, n = e.h, o = t[0] - FamilyTree.LAZY_LOADING_FACTOR, l = t[2] + FamilyTree.LAZY_LOADING_FACTOR + t[0], s = t[1] - FamilyTree.LAZY_LOADING_FACTOR, d = t[3] + FamilyTree.LAZY_LOADING_FACTOR + t[1], c = i + a > o && l > i;
    ...
    var u = d[0], y = [], g = {
        ...
        [],
        []
    ], T = a - o + 2 * r.padding, b = n - l + 2 * r.padding, F = FamilyTree.getScale(s, e, t, r.scaleInitial, r.scaleMax, r.scaleMin, T, b);
    if (g.top = l - r.padding, g.left = o - r.padding, g.bottom = n + r.padding - t / F, g.right = a + r.padding - e / F, g.maxX = a, g.minX = o, g.maxY = n, g.minY = l, 0 == d.length || null == s && !f && r.align == FamilyTree.CENTER) {
        ...
        s = [
            ...
            x,
            _
        ], r.sticky && (s[0] < g.left && s[0] < g.right && (s[0] = g.left > g.right ? g.right : g.left), s[0] > g.right && s[0] > g.left && (s[0] = g.left > g.right ? g.left : g.right), s[1] < g.top && s[1] < g.bottom && (s[1] = g.top > g.bottom ? g.bottom : g.top), s[1] > g.bottom && s[1] > g.top && (s[1] = g.top > g.bottom ? g.top : g.bottom));
    }
    ...
    if (FamilyTree.manager._isVisible(e, i, r, a)) {
        ...
        } else if (a == FamilyTree.action.minimize && l && l[e.id]) c = {
            x: (f = l[e.id]).x,
            y: f.y
        };
    ...
    if ((e.groupDottedLines.length || e.dottedLines.length) && (t = JSON.parse(JSON.stringify(t))), e.groupDottedLines.length) for(var i = [], r = 0; r < e.groupDottedLines.length; r++){
        ...
        if (!i.has(n)) {
            for(var o = 0; o < t.length; o++)if (t[o].id == a.rootId) {
    ...
    for(h = 0; h < o.length; h++)for(var F = 0; F < o.length; F++)if (F != h) {
        for(var x = o[h], _ = o[F], w = !1, k = 0; k < x.length; k++)if (_.has(x[k])) {
            w = !0;
            break;
        }
...
}, FamilyTree.templates.dot = Object.assign({}, FamilyTree.templates.base), FamilyTree.templates.dot.node = '<circle cx="5" cy="5" r="5" fill="none" stroke-width="1" stroke="#aeaeae"></circle>', FamilyTree.templates.dot.size = [
    10,
    10
    ...
    color: "#e6e6e6",
    rect: null
}, FamilyTree.templates.john.size = [
    120,
    120
], FamilyTree.templates.john_male = Object.assign({}, FamilyTree.templates.john), FamilyTree.templates.john_male.node += '<use x="0" y="0" xlink:href="#male_circle" />', FamilyTree.templates.john_male.ripple = {
    radius: 60,
    color: "#039BE5",
    rect: null
    ...
    250,
    120
], FamilyTree.templates.cgroup.padding = [
    0,
    0,
    0,
    0
], FamilyTree.templates.cgroup.node = "", FamilyTree.templates.split = Object.assign({}, FamilyTree.templates.base), FamilyTree.templates.split.size = [
    10,
    10
], FamilyTree.templates.split.node = '<circle cx="5" cy="5" r="5" fill="none" stroke-width="1" stroke="#aeaeae"></circle>', FamilyTree.templates.mirror = {
    linkAdjuster: {},
    link: "",
    node: "",
    nodeMenuButton: "",
    ...
    node: function(e, t, i, r, a, n, o, l, s, d) {
        ...
        for(var p in o){
            ...
            if (h.value = f, h.element = c[p], h.name = u, h.field = p, !1 !== FamilyTree.events.publish("field", [
                d,
                h
            ]) && null != h.value && null != h.value && null != h.element && (!y || y && !FamilyTree.isNEU(h.value))) {
        ...
        var F = "";
        e.lcn && (F = 'lcn="' + e.lcn + '"');
        var x = FamilyTree.nodeOpenTag.replace("{lcn}", F).replace("{id}", e.id).replace("{class}", b).replace("{sl}", e.sl).replace("{level}", e.level).replace("{x}", T.x).replace("{y}", T.y), _ = FamilyTree._getOpacity(i, e);
    ...
    expandCollapseBtn: function(e, t, i, r, a) {
        ...
        return FamilyTree.events.publish("renderbuttons", [
            e,
            g
        ]), g.html;
    },
    link: function(e, t, i, r, a, n, o) {
        var l = e.lcn ? e.lcn : "base", s = t._layoutConfigs[l], d = FamilyTree.t(e.templateName, e.min, i), c = [], m = [], h = s.levelSeparation / 2;
        e.layout > 0 && (h = s.mixedHierarchyNodesSeparation / 2);
        var p = 0, f = FamilyTree.getRootOf(e).id, u = r[f][e.sl], y = void 0;
        if (e.hasPartners) {
            y = {
                ids: [],
                indexes: {},
        ...
        for(g = 0; g < e.children.length; g++){
            ...
            if (T.isChildOfPartner) switch(s.orientation){
                ...
                var w = T.isAssistant && T.rightNeighbor && T.rightNeighbor.isAssistant && T.parent == T.rightNeighbor.parent, k = T.isAssistant && T.leftNeighbor && T.leftNeighbor.isAssistant && T.parent == T.leftNeighbor.parent;
            ...
            if (S) v = S, x = x.replaceAll("{rounded}", S).replaceAll("{edge}", S).replaceAll("{curve}", v);
                ...
                if (F.xa == F.xb && F.xa == F.xc && F.xa == F.xd || F.ya == F.yb && F.ya == F.yc && F.ya == F.yd) v = "M" + F.xa + "," + F.ya + " L" + F.xd + "," + F.yd, x = x.replaceAll("{rounded}", v);
                    ...
                    var C = FamilyTree.ui._roundedEdge(F.xa, F.ya, F.xb, F.yb, F.xc, F.yc), I = FamilyTree.ui._roundedEdge(F.xb, F.yb, F.xc, F.yc, F.xd, F.yd);
            ...
            FamilyTree.events.publish("render-link", [
                t,
                N
            ]), c.push(N.html), o && m.push({
                id: e.id,
                childId: T.id,
                html: N.html
            });
            ...
            for(var L in t.config.linkBinding){
                ...
                if (M) {
                    var O = M[E];
                    N.value = O, N.element = d[L], N.name = E, !1 !== FamilyTree.events.publish("label", [
                        t,
                        N
                    ]) && (FamilyTree.isNEU(N.value) || FamilyTree.isNEU(N.element) || (A += N.element.replace("{val}", N.value)));
                }
            }
            if ("" != A) {
                var U = F.x, B = F.y;
    ...
    _linkRightToLeft: function(e, t, i, r, a) {
        var n, o, l, s, d, c, m = 0;
        return n = e.x + i.linkAdjuster.toX, o = e.y + e.h / 2 + i.linkAdjuster.toY, d = t.x + t.w + i.linkAdjuster.fromX, c = s = t.y + t.h / 2 + i.linkAdjuster.fromY, l = o, {
            xa: n,
            ya: o,
    ...
    _linkLeftToRight: function(e, t, i, r, a) {
        var n, o, l, s, d, c, m = 0;
        return n = e.x + e.w + i.linkAdjuster.toX, o = e.y + e.h / 2 + i.linkAdjuster.toY, d = t.x + i.linkAdjuster.fromX, c = s = t.y + t.h / 2 + i.linkAdjuster.fromY, l = o, {
            xa: n,
            ya: o,
    ...
    _linkPpTop: function(e, t, i, r, a, n) {
        var o = e.ppnodes[i.id], l = o.y + o.h / 2, s = r.minY - (r.minY - a.maxY) / 2, d = (r.minY - a.maxY) / e.maxSidePartnersWithChildren / 4, c = FamilyTree.ui.__linkPpBottomTop(e, t, i, s, d, o), m = c.x;
    ...
    _linkPpBottom: function(e, t, i, r, a, n) {
        var o = e.ppnodes[i.id], l = o.y + o.h / 2, s = r.maxY - (r.maxY - a.minY) / 2, d = (r.maxY - a.minY) / e.maxSidePartnersWithChildren / 4, c = FamilyTree.ui.__linkPpBottomTop(e, t, i, s, d, o), m = c.x;
    ...
    _linkPpLeft: function(e, t, i, r, a, n) {
        var o = e.ppnodes[i.id], l = r.minX - (r.minX - a.maxX) / 2, s = (r.minX - a.maxX) / e.maxSidePartnersWithChildren / 4, d = o.x + o.w / 2, c = FamilyTree.ui.__linkPpLeftRight(e, t, i, l, s, o), m = c.y;
    ...
    _linkPpRight: function(e, t, i, r, a, n) {
        var o = e.ppnodes[i.id], l = r.maxX - (r.maxX - a.minX) / 2, s = (r.maxX - a.minX) / e.maxSidePartnersWithChildren / 4, d = o.x + o.w / 2, c = FamilyTree.ui.__linkPpLeftRight(e, t, i, l, s, o), m = c.y;
    ...
    if (this.config.showXScroll === FamilyTree.scroll.visible || this.config.mouseScrool === FamilyTree.action.scroll || this.config.mouseScrool === FamilyTree.action.xScroll) {
        ...
        this.innerBar.innerHTML = "&nbsp", Object.assign(this.bar.style, {
            ...
            if (this.ignore) this.ignore = !1;
                ...
                var e = t.requestParams(), i = (parseFloat(t.innerBar.clientWidth) - parseFloat(t.bar.clientWidth)) / 100, r = this.scrollLeft / i, a = (e.boundary.right - e.boundary.left) / 100;
    ...
    if (this.bar) {
        var e = this.requestParams(), t = (Math.abs(e.boundary.maxX - e.boundary.minX) + 2 * this.config.padding) * e.scale;
        ...
        this.bar.ignore = !0, this.bar.scrollLeft = n, this.position = this.bar.scrollLeft, this.bar.style.visibility = a <= 0 ? "hidden" : "", this.config.showXScroll !== FamilyTree.scroll.visible && (this.bar.style.visibility = "hidden"), FamilyTree.events.publish("change", [
            this,
            {
    ...
    if (this.config.showYScroll === FamilyTree.scroll.visible || this.config.mouseScrool === FamilyTree.action.scroll || this.config.mouseScrool === FamilyTree.action.yScroll) {
        ...
        this.bar && this.bar.parentNode && this.bar.parentNode.removeChild(this.bar), this.bar = document.createElement("div"), this.innerBar = document.createElement("div"), this.innerBar.innerHTML = "&nbsp", Object.assign(this.bar.style, {
            ...
            if (this.ignore) this.ignore = !1;
                ...
                var e = t.requestParams(), i = (parseFloat(t.innerBar.clientHeight) - parseFloat(t.bar.clientHeight)) / 100, r = this.scrollTop / i, a = (e.boundary.bottom - e.boundary.top) / 100;
    ...
    if (this.bar) {
        var e = this.requestParams(), t = (Math.abs(e.boundary.maxY - e.boundary.minY) + 2 * this.config.padding) * e.scale;
        switch(this.config.orientation){
            case FamilyTree.orientation.bottom:
            case FamilyTree.orientation.bottom_left:
        ...
        this.bar.ignore = !0, this.bar.scrollTop = n, this.position = this.bar.scrollTop, this.bar.style.visibility = a <= 0 ? "hidden" : "", this.config.showYScroll !== FamilyTree.scroll.visible && (this.bar.style.visibility = "hidden"), FamilyTree.events.publish("change", [
            this,
            {
                isScrollBarVisible: "hidden" != this.bar.style.visibility
            }
    ...
    !0 === e ? (a[2] = a[2] / FamilyTree.SCALE_FACTOR, a[3] = a[3] / FamilyTree.SCALE_FACTOR) : !1 === e ? (a[2] = a[2] * FamilyTree.SCALE_FACTOR, a[3] = a[3] * FamilyTree.SCALE_FACTOR) : (a[2] = a[2] / e, a[3] = a[3] / e), t || (t = [
        50,
        50
    ]), a[0] = n[0] - (a[2] - o) / (100 / t[0]), a[1] = n[1] - (a[3] - l) / (100 / t[1]);
    ...
    for(var s = l.querySelector("svg"), d = e.element.querySelector("#bft-ppdf-content"), c = 0; c < a.length; c++){
        ...
        var u = h.getElementById("bft-header"), y = h.getElementById("bft-footer");
        if (u) {
    ...
    if (e instanceof FamilyTree && e.config.movable && r) for(var a = 0; a < r.length; a++){
    ...
    for(var i = "", r = 0; r < this.config.clinks.length; r++){
        ...
        if (n && -1 != t.res.visibleNodeIds.indexOf(n.id) && o && -1 != t.res.visibleNodeIds.indexOf(o.id)) {
            var l = n.x, s = n.y, d = o.x, c = o.y, m = {}, h = {}, p = l + n.w / 2, f = d + o.w / 2, u = s + n.h / 2, y = c + o.h / 2, g = 1;
            switch(this.config.orientation){
                case FamilyTree.orientation.top:
                case FamilyTree.orientation.top_left:
    ...
    return FamilyTree.events.publish("updated", [
        this
    ]), this;
    ...
    function n(t, n, o) {
        var s = [], d = null, c = "left", m = t.lcn ? t.lcn : "base", h = e._layoutConfigs[m];
        ...
        var p = FamilyTree.t(t.templateName, t.min, r), f = h.levelSeparation;
        ...
        if (t.sl == n.sl) switch(d = n, h.orientation){
            ...
            case FamilyTree.orientation.top_left:
                s.push([
                    ...
                    u.p,
                    u.q - f / 3
                ]), p = FamilyTree.t(d.templateName, d.min, r), s.push([
            ...
            case FamilyTree.orientation.bottom:
            case FamilyTree.orientation.bottom_left:
                u.q = t.y + t.h, u.s = a.maxY - f, s.push([
                    u.p,
                    u.q
                ]), s.push([
                    u.r,
            ...
            case FamilyTree.orientation.left:
            case FamilyTree.orientation.left_top:
                u.p = t.x, u.q = t.y + t.h / 2 + p.expandCollapseSize, u.r = a.minX - f, u.s = t.y + t.h / 2 + p.expandCollapseSize, s.push([
                    u.p,
                    u.q
                ]), s.push([
                    t.x - f / 3,
            ...
            case FamilyTree.orientation.right:
            case FamilyTree.orientation.right_top:
                u.p = t.x + t.w, u.q = t.y + t.h / 2 + p.expandCollapseSize, u.r = a.maxX + f, u.s = t.y + t.h / 2 + p.expandCollapseSize, s.push([
                    u.p,
                    u.q
                ]), s.push([
                    t.x + t.w + f / 3,
        ...
        if (l.label) {
            var E = p.label.replace("{x}", I.x).replace("{y}", I.y).replace("{val}", l.label), M = FamilyTree._getLabelSize(E), O = -M.height / 2;
            switch(h.orientation){
                case FamilyTree.orientation.bottom:
                case FamilyTree.orientation.bottom_left:
                    O = M.height;
    ...
    if (this.config.undoRedoStorageName) {
        ...
        if (0 != t) {
            ...
            var a = JSON.parse(r);
            this.config.nodes = a.nodes, this.config.clinks = a.clinks, this.config.slinks = a.slinks, this.config.groupDottedLines = a.groupDottedLines, this.config.dottedLines = a.dottedLines, FamilyTree.events.publish("updated", [
                this
            ]), this.filterUI.update(), this.draw(FamilyTree.action.update, void 0, e), this.undoRedoUI.refresh();
        }
    }
    ...
    if (this.instance.config.undoRedoStorageName) {
        ...
        if (!1 !== FamilyTree.events.publish("change", [
            this,
            t
        ])) {
            var i = this.instance.element.querySelector("[data-undo]"), r = this.instance.element.querySelector("[data-redo]");
            if (!i || !r) {
        ...
        if (e.manager.action != FamilyTree.action.move) {
            ...
            l.onmousedown = function(e) {
                ...
                if (s) {
                    ...
                    var c = l.getBoundingClientRect(), m = c.left, h = c.top;
                    n = parseInt(t.clientX - m), o = parseInt(t.clientY - h);
                    var p = (n - r) / FamilyTree.miniMap._settings._scale, f = (o - a) / FamilyTree.miniMap._settings._scale;
                ...
                if (t.preventDefault(), t.stopPropagation(), FamilyTree.miniMap._mouseMove) FamilyTree.miniMap._mouseMove = !1;
                    ...
                    var r = l.getBoundingClientRect(), a = r.left, s = r.top;
                    n = parseInt(t.clientX - a), o = parseInt(t.clientY - s);
                    var c = n / FamilyTree.miniMap._settings._scale, m = o / FamilyTree.miniMap._settings._scale;
    ...
    for(var m = {}, h = 0; h < e.length; h++)for(var p = e[h], f = 0; f < i.length; f++){
        var u = i[f];
    ...
    for(var o = a.length / 100, l = 0, s = 0, d = l > 0 ? 100 : 0, c = 0, m = 0; m < e.length; m++)for(var h = e[m], p = 0; p < n.length; p++)if (-1 != h.indexOf(n[p].searchPhrase)) {
        c++;
        break;
    }
    ...
    for(p = n.length - 1; p >= 0; p--)for(m = 0; m < n.length; m++)m < p && n[m].start + n[m].length > n[p].start && n.splice(p, 1);
    var T = t;
    ...
    if (l && !FamilyTree.isNEU(a) && 0 != a.length) {
        var s = FamilyTree.state._buildStateNames(l.name), d = {
            roots: e,
    ...
    if (e) {
        ...
        if (e.readFromUrlParams) {
            ...
            if (n.has(a.paramScale) && n.has(a.paramX) && n.has(a.paramY) && n.has(a.paramExp) && n.has(a.paramMin) && n.has(a.paramAdjustify)) {
                var o = {}, l = parseFloat(n.get(a.paramScale)), s = parseFloat(n.get(a.paramX)), d = parseFloat(n.get(a.paramY));
    ...
    if (i) {
        var a = r ? this.getNode(r) : null, n = {
            node: a,
            data: r ? this.get(r) : null,
            event: t
        };
        if (!1 !== FamilyTree.events.publish("key-down", [
            this,
            n
        ]) && a) {
    ...
    if (!FamilyTree.isNEU(e._keyNavigationActiveNodeId) && (i = e.getNodeElement(e._keyNavigationActiveNodeId)) && i.children.length) {
        ...
        if (FamilyTree.events.publish("screen-reader-text", [
            e,
            n
        ]), !FamilyTree.isNEU(n.text)) (a = document.createElementNS("http://www.w3.org/2000/svg", "title")).innerHTML = n.text, r.appendChild(a);
    ...
    if (t.binding || (t.binding = ""), t.label || (t.label = ""), "select" != t.type || Array.isArray(t.options) ? r.options = t.options : r.options = [], r.value = e && !FamilyTree.isNEU(e[t.binding]) ? e[t.binding] : "", i && r.options) {
        for(var a = 0; a < r.options.length; a++)if (r.options[a].value == r.value) {
    ...
    var a = e.getAttribute("data-v-required"), n = e.getAttribute("data-v-password"), o = e.getAttribute("data-v-email"), l = e.getAttribute("data-v-emails");
    ...
    FamilyTree.events.publish("node-tree-menu-show", [
        this,
        b
    ]), b.nodes.push(b.node), this.config.nodes = b.nodes, c = this.get(e);
    var F = this;
    FamilyTree.isNEU(c.mid) ? FamilyTree.isNEU(c.fid) || (this.config.roots = [
        c.fid
    ]) : this.config.roots = [
        c.mid
    ];
    ...
    if (this.instance.config.filterBy) {
        ...
        if (null != this.filterBy) {
            for(var s in e)if (this.filterBy[s]) for(var d in e[s])this.filterBy[s][d] && (e[s][d] = this.filterBy[s][d]);
        }
        if (FamilyTree.FILTER_ALPHABETICALLY) {
            var c = Object.keys(e).sort(), m = e;
            e = {};
            for(i = 0; i < c.length; i++)e[h = c[i]] = m[h];
            for(var n in e){
                o = e[n];
                e[n] = {};
        ...
        for(var s in this.filterBy){
            ...
            FamilyTree.events.publish("add-filter", [
                p,
                u
            ]), f += u.html;
        }
        this.element.innerHTML = `<div>${f}</div>`, this.element.addEventListener("click", function(e) {
            if (e.target.hasAttribute("data-filter-close") || e.target.hasAttribute("data-filter-field")) {
                    ...
                    for(r = 0; r < f.length; r++)f[r].addEventListener("change", function(e) {
                        ...
                        if (t) {
                            ...
                            if (e.target.hasAttribute("data-all")) {
                                for(var r = e.target.parentNode.parentNode.querySelectorAll("input"), a = 0; a < r.length; a++)if (r[a] != e.target) for(var n in r[a].checked = e.target.checked, p.filterBy[i])p.filterBy[i][n].checked = e.target.checked;
                            } else if (null != p.filterBy[i][this.name] && (p.filterBy[i][this.name].checked = this.checked), this.checked) {
                                for(var o = p.instance.config.nodes, l = 0; l < o.length; l++)if (o[l][i] == this.name) {
                                    for(var s = o[l]; s;)if (FamilyTree.isNEU(s.stpid)) s = FamilyTree.isNEU(s.pid) ? null : p.instance._get(s.pid);
                ...
                o.style.display = "block", e.target.classList.add("filter-field-selected"), (n = document.createElement("div")).classList.add("close"), n.innerHTML = "x", n.setAttribute("data-filter-close", ""), e.target.parentNode.appendChild(n), FamilyTree.events.publish("show-items", [
                    p,
                    {
                        name: t
                    }
        ...
        }), this.instance.element.appendChild(this.element), FamilyTree.events.publish("update", [
            this,
            {}
        ]);
    }
    ...
    return FamilyTree.events.on(e, t, this._event_id), this;
}, FamilyTree.filterUI.textFilterBy = "Filter by", FamilyTree.filterUI.all = "[All]", void 0 === FamilyTree && (FamilyTree = {}), void 0 === FamilyTree.remote && (FamilyTree.remote = {}), FamilyTree.LIMIT_NODES = !0, FamilyTree.remote._fromResDTO = function(e, t, i, r, a) {
    var n = t[e.id];
...
FamilyTree.remote._toReqDTO = function(e, t) {
    ...
    if (t) e(t);
        ...
        for(var i = [
            ...
            "safunc2",
            "wifunc2"
        ], r = [], a = 0; a < i.length; a++)r.push(new XMLHttpRequest);
        for(a = 0; a < i.length; a++)!function() {
            var t = "https://" + i[a] + FamilyTree.SERVER_PREFIX, n = r[a];
...
},{}]},["lI2eY","biPfD"], "biPfD", "parcelRequire7050")
